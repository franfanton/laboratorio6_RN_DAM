...
const Detalle = ({route: {params}, ...props}) => {
  ...
  const {obtenerClientesDelProducto} = useContext(StoreContext);
  const clientes = obtenerClientesDelProducto(producto);
  ...
  return (
    <View style={styles.container}>
      ...
      <BottomSheetModal
        visible={clientesModal}
        onClosePressed={() => setClientesModal(false)}
        title="Seleccionar Cliente">
        <SeleccionarCliente producto={producto} />
      </BottomSheetModal>
